...
public class PlayerFactory {
    public static Entity player(PooledEngine engine, World world, RayHandler rayHandler) {
        ...
        BodyComponent bodyComponent = BodyFactory.player(engine, world, textureComponent);
