...
import com.mygdx.totaldefense.controllers.Controllers;
...
//        }
        ...
        //body.body.setLinearVelocity(Controllers.getLeftAxis().x * body.moveSpeed.x, Controllers.getLeftAxis().y * body.moveSpeed.y);
    }
}
